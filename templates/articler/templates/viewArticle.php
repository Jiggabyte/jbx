<div id="blogTop" style="position:relative;left:0px;top:0px;">
   ...
   <!-- <img id="imager" alt="Image" src="uploads/<?php echo $results['article']->image; ?>" style="width:300px;height:;border-radius:5px;"> -->
    ...
    <br /><br />
      ...
      <div class="cont" style="width: 75%;font-size:1.3em;margin-top:20px;">
          <style>
              .cont,span {
      ...
      <p><a href="blog.php#blogTop">Home</a></p>
