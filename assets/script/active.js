    ...
    function custom() {
            ...
            $(window).on('scroll',function(){
                if($(window).scrollTop()>50){
                    ...
                    $('header .container .logo img').attr('src','img/logo.png');
                    $('header .signup ul.menu li a.btn').addClass('change');
                }
                else{
                    $('header').removeClass('sticky');
                    $('header .container .logo img').attr('src','img/logo-white.png');
                    $('header .signup ul.menu li a.btn').removeClass('change');
                }
            });
